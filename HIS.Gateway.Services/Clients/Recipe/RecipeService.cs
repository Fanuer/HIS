...
{
    internal class RecipeService : RmServiceBase, IRecipeService
    {
        #region CONST
        ...
        #region CTOR
        public RecipeService(IOptions<GatewayInformation> clientOptions, ILoggerFactory factory)
            : base(clientOptions, factory.CreateLogger<RecipeService>())
        {
        }
        #endregion
