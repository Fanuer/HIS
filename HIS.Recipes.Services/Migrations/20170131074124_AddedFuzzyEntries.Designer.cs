...
namespace HIS.Recipes.Services.Migrations
{
    ...
    [Migration("20170131074124_AddedFuzzyEntries")]
    partial class AddedFuzzyEntries
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HIS.Recipes.Services.Models.FuzzyEntry", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.HasKey("Id", "SearchQuery", "Type");

                    b.ToTable("FuzzyEntries");
                });
