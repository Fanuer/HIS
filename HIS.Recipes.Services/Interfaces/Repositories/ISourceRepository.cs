...
{
    internal interface ISourceRepository<T> : IDisposable, IRepositoryFindAll<T>, IRepositoryAddAndDelete<T, int>, IRepositoryFindSingle<T, int>, IRepositoryUpdate<T, int> where T: RecipeBaseSource
    {
    }
